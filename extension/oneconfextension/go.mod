module github.com/sergeysedoy97/opentelemetry-collector-contrib/extension/oneconfextension
...
require (
	...
	gitlab.rip/golang/platform-tech-services/one_configuration v1.20.3 // indirect
